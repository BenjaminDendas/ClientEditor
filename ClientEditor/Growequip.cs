...
{
    public class Growequip : AkEditor
    {
        ...
        public Growequip(string u1, string u2, string u3, string u4, string u5, string u6, string u7,
                         string u8, string u9, string u10, string u11, string u12, string u13, string u14, string u15)
        {
            this.Unknown1 = u1;
            this.Unknown2 = u2;
            this.Unknown3 = u3;
